...
void moveGyroPID(float distance, int forward) {
	...
	// outdoor
//	if (forward) {
//			if (distance == 10) distErrOffset =DISTANCE_ERROR_OFFSETF;
//			else if (distance == 20) distErrOffset = DISTANCE_ERROR_OFFSETF;
...
//	__HAL_TIM_SetCompare(&htim8,TIM_CHANNEL_3, 2950);
//	while (moving) {
//
//		if (totalAngle >= 84) {
//			break;
